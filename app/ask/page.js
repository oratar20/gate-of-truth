...
import { Starfield, useCosmosChrome } from '@/components/kavanot/Cosmos';
...
export default function Home() {
  ...
  // פלטת מונוכרום-זוהר: רקע שחור, אור לבן-כסוף, קלף.
  // שמות המפתחות נשמרים כדי שכל ההפניות בקוד ימשיכו לעבוד.
  const colors = {
    bg: '#06040a',
    deepBlue: '#0b0910',
    midPurple: '#141320',
    deepPurple: '#201d2e',
    gold: '#cdc8bb',        // כסוף-קלף — גוון ההדגשה
    goldBright: '#fbfaf5',  // האור הזוהר
    goldDim: '#7c776c',
    cream: '#ece8df',
    creamMuted: '#9a9488',
    purpleLight: '#b9b4c6',
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'} style={{
      ...
      <Starfield count={52} reduce={reduce} />
      ...
      <a href="/" aria-label={isRTL ? 'חזרה לשער' : 'Back to gate'} style={{
        position: 'fixed', top: '1.3rem', [isRTL ? 'right' : 'left']: '1.3rem',
        zIndex: 100, color: colors.creamMuted, fontFamily: fontBody,
        ...
        {stage === 'q3' && (
          <div className="fade-up" style={{ paddingTop: '4rem' }}>
            <div style={{ ...glassCard, padding: '3rem 2rem' }}>
              <div style={{ textAlign: 'center', color: colors.goldBright, fontSize: '0.85rem', letterSpacing: '0.4em', marginBottom: '2rem', opacity: 0.7 }}>
                ✦
              </div>
