...
export const STRINGS = {
  ...
  'gate.gilgul.label':  { he: 'גִּלְגּוּל הַנִּיקּוּד', en: 'Vowel Cycling', es: 'Ciclo de Vocales' },
  'gate.gilgul.sub':    { he: 'אור השכל · אבולעפיה', en: 'Or HaSechel · Abulafia', es: 'Or HaSéjel · Abulafia' },
};
